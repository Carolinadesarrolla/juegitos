...
const commonWords: WordItem[] = [
    { id: "w1", word: "مَرْحَبًا", latin: "marhaban", meanings: { es: "hola", de: "Hallo", pl: "cześć", pt: "olá", uk: "привіт", la: "hola" }, breakdown: "م + ر + ح + ب + ا" },
    { id: "w2", word: "شُكْرًا", latin: "shukran", meanings: { es: "gracias", de: "Danke", pl: "dziękuję", pt: "obrigado", uk: "дякую", la: "gracias" }, breakdown: "ش + ك + ر + ا" },
    { id: "w3", word: "نَعَمْ", latin: "na'am", meanings: { es: "sí", de: "ja", pl: "tak", pt: "sim", uk: "так", la: "sí" }, breakdown: "ن +  ع + م" },
    { id: "w4", word: "لَا", latin: "la", meanings: { es: "no", de: "nein", pl: "nie", pt: "não", uk: "ні", la: "no" }, breakdown: "ل + ا" },
    { id: "w5", word: "مِنْ فَضْلِكَ", latin: "min fadlik", meanings: { es: "por favor (a hombre)", de: "bitte (m)", pl: "proszę (m)", pt: "por favor (m)", uk: "будь ласка (м)", la: "por favor (a hombre)" }, breakdown: "م + ن +   + ف + ض + ل + ك" },
    { id: "w6", word: "بِخَيْر", latin: "bikhayr", meanings: { es: "bien", de: "gut / okay", pl: "dobrze", pt: "bem", uk: "добре", la: "bien" }, breakdown: "ب + خ + ي + ر" },
    { id: "w7", word: "أَهْلًا", latin: "ahlan", meanings: { es: "hola / bienvenido", de: "Willkommen / Hallo", pl: "witaj", pt: "olá / bem-vindo", uk: "привіт / ласкаво просимо", la: "hola / bienvenido" }, breakdown: "أ + ه + ل + ا" },
    { id: "w8", word: "مَعَ السَّلَامَة", latin: "ma'a salama", meanings: { es: "adiós", de: "auf Wiedersehen", pl: "do widzenia", pt: "adeus", uk: "до побачення", la: "adiós" }, breakdown: "م + ع +   + ا + ل + س + ل + ا + م + ة" },
    { id: "w9", word: "صَدِيق", latin: "sadiq", meanings: { es: "amigo", de: "Freund", pl: "przyjaciel", pt: "amigo", uk: "друг", la: "amigo" }, breakdown: "ص + د + ي + ق" },
    { id: "w10", word: "كِتَاب", latin: "kitab", meanings: { es: "libro", de: "Buch", pl: "książka", pt: "livro", uk: "книга", la: "libro" }, breakdown: "ك + ت + ا + ب" },
    { id: "w11", word: "مَاء", latin: "ma'", meanings: { es: "agua", de: "Wasser", pl: "woda", pt: "água", uk: "вода", la: "agua" }, breakdown: "م + ا + ء" },
    { id: "w12", word: "خُبْز", latin: "khubz", meanings: { es: "pan", de: "Brot", pl: "chleb", pt: "pão", uk: "хліб", la: "pan" }, breakdown: "خ + ب + ز" },
    { id: "w13", word: "حَلِيب", latin: "halib", meanings: { es: "leche", de: "Milch", pl: "mleko", pt: "leite", uk: "молоко", la: "leche" }, breakdown: "ح + ل + ي + ب" },
    { id: "w14", word: "شَاي", latin: "shay", meanings: { es: "té", de: "Tee", pl: "herbata", pt: "chá", uk: "чай", la: "té" }, breakdown: "ش + ا + ي" },
    { id: "w15", word: "قَهْوَة", latin: "qahwa", meanings: { es: "café", de: "Kaffee", pl: "kawa", pt: "café", uk: "кава", la: "café" }, breakdown: "ق + ه + و + ة" },
    { id: "w16", word: "بَيْت", latin: "bayt", meanings: { es: "casa", de: "Haus", pl: "dom", pt: "casa", uk: "дім", la: "casa" }, breakdown: "ب + ي + ت" },
    { id: "w17", word: "مَدِينَة", latin: "madina", meanings: { es: "ciudad", de: "Stadt", pl: "miasto", pt: "cidade", uk: "місто", la: "ciudad" }, breakdown: "م + د + ي + ن + ة" },
    { id: "w18", word: "عَائِلَة", latin: "a'ila", meanings: { es: "familia", de: "Familie", pl: "rodzina", pt: "família", uk: "сім'я", la: "familia" }, breakdown: "ع + ا + ئ + ل + ة" },
    { id: "w19", word: "شَارِع", latin: "shari'", meanings: { es: "calle", de: "Straße", pl: "ulica", pt: "rua", uk: "вулиця", la: "calle" }, breakdown: "ش + ا + ر + ع" },
    { id: "w20", word: "عَمَل", latin: "amal", meanings: { es: "trabajo", de: "Arbeit", pl: "praca", pt: "trabalho", uk: "робота", la: "trabajo" }, breakdown: "ع + م + ل" },
    { id: "w21", word: "حُبّ", latin: "hubb", meanings: { es: "amor", de: "Liebe", pl: "miłość", pt: "amor", uk: "любов", la: "amor" }, breakdown: "ح + ب" },
    { id: "w22", word: "حَيَاة", latin: "hayat", meanings: { es: "vida", de: "Leben", pl: "życie", pt: "vida", uk: "життя", la: "vida" }, breakdown: "ح + ي + ا + ة" },
    { id: "w23", word: "وَلَد", latin: "walad", meanings: { es: "niño / hijo", de: "Junge / Kind", pl: "chłopiec / syn", pt: "menino / filho", uk: "хлопчик / син", la: "niño / hijo" }, breakdown: "و + ل + د" },
    { id: "w24", word: "بِنْت", latin: "bint", meanings: { es: "niña / hija", de: "Mädchen / Tochter", pl: "dziewczynka / córka", pt: "menina / filha", uk: "дівчинка / донька", la: "niña / hija" }, breakdown: "ب + ن + ت" },
    { id: "w25", word: "صَبَاح الْخَيْر", latin: "sabah al-khayr", meanings: { es: "buenos días", de: "Guten Morgen", pl: "dzień dobry (rano)", pt: "bom dia", uk: "доброго ранку", la: "buenos días" }, breakdown: "ص + ب + ا + ح +   + ا + ل + خ + ي + ر" },
    { id: "w26", word: "مَسَاء الْخَيْر", latin: "massa' al-khayr", meanings: { es: "buenas tardes", de: "Guten Abend", pl: "dobry wieczór", pt: "boa tarde / noite", uk: "доброго вечора", la: "buenas tardes" }, breakdown: "م + س + a + ء +   + ا + ل + خ + ي + ر" }, // wait, مَسَاء: م + س + ا + ء
    { id: "w27", word: "لَيْلَة سَعِيدَة", latin: "layla sa'ida", meanings: { es: "buenas noches", de: "Gute Nacht", pl: "dobranoc", pt: "boa noite (despedida)", uk: "надобраніч", la: "buenas noches" }, breakdown: "ل + ي + ل + ة +   + س + ع + ي + د + ة" },
    { id: "w28", word: "مَدْرَسَة", latin: "madrasa", meanings: { es: "escuela", de: "Schule", pl: "szkoła", pt: "escola", uk: "школа", la: "escuela" }, breakdown: "م + د + ر + س + ة" },
    { id: "w29", word: "شَمْس", latin: "shams", meanings: { es: "sol", de: "Sonne", pl: "słońce", pt: "sol", uk: "сонце", la: "sol" }, breakdown: "ش + م + س" },
    { id: "w30", word: "بَلَد", latin: "balad", meanings: { es: "país", de: "Land", pl: "kraj", pt: "país", uk: "країна", la: "país" }, breakdown: "ب + ل + د" },
    { id: "w31", word: "وَقْت", latin: "waqt", meanings: { es: "tiempo", de: "Zeit", pl: "czas", pt: "tempo", uk: "час", la: "tiempo" }, breakdown: "و + ق + ت" },
    { id: "w32", word: "مَطْعَم", latin: "mat'am", meanings: { es: "restaurante", de: "Restaurant", pl: "restauracja", pt: "restaurante", uk: "ресторан", la: "restaurante" }, breakdown: "م + ط + ع + م" },
    { id: "w33", word: "تَذْكِرَة", latin: "tadhkira", meanings: { es: "billete / boleto", de: "Ticket", pl: "bilet", pt: "bilhete", uk: "квиток", la: "billete / boleto" }, breakdown: "ت + ذ + ك + ر + ة" },
    { id: "w34", word: "كَلْب", latin: "kalb", meanings: { es: "perro", de: "Hund", pl: "pies", pt: "cão / cachorro", uk: "собака", la: "perro" }, breakdown: "ك + ل + ب" },
    { id: "w35", word: "قِطَّة", latin: "qitta", meanings: { es: "gato", de: "Katze", pl: "kot", pt: "gato", uk: "кішка / кіт", la: "gato" }, breakdown: "ق + ط + ة" },
    { id: "w36", word: "تُفَّاحَة", latin: "tuffaha", meanings: { es: "manzana", de: "Apfel", pl: "jabłko", pt: "maçã", uk: "яблуко", la: "manzana" }, breakdown: "ت + ف + ا + ح + ة" },
    { id: "w37", word: "وَاحِد", latin: "wahid", meanings: { es: "uno", de: "eins", pl: "jeden", pt: "um", uk: "один", la: "uno" }, breakdown: "و + ا + ح + د" },
    { id: "w38", word: "اِثْنَان", latin: "ithnan", meanings: { es: "dos", de: "zwei", pl: "dwa", pt: "dois", uk: "два", la: "dos" }, breakdown: "ا + ث + ن + ا + ن" },
    { id: "w39", word: "ثَلَاثَة", latin: "thalatha", meanings: { es: "tres", de: "drei", pl: "trzy", pt: "três", uk: "три", la: "tres" }, breakdown: "ث + ل + ا + ث + ة" },
    { id: "w40", word: "أَرْبَعَة", latin: "arba'a", meanings: { es: "cuatro", de: "vier", pl: "cztery", pt: "quatro", uk: "чотири", la: "cuatro" }, breakdown: "أ + ر + ب + ع + ة" },
    { id: "w41", word: "خَمْسَة", latin: "khamsa", meanings: { es: "cinco", de: "fünf", pl: "pięć", pt: "cinco", uk: "п'ять", la: "cinco" }, breakdown: "خ + م + س + ة" },
    { id: "w42", word: "قَمَر", latin: "qamar", meanings: { es: "luna", de: "Mond", pl: "księżyc", pt: "lua", uk: "місяць", la: "luna" }, breakdown: "ق + م + ر" },
    { id: "w43", word: "جَمِيل", latin: "jamil", meanings: { es: "hermoso", de: "schön", pl: "piękny", pt: "bonito", uk: "гарний", la: "hermoso" }, breakdown: "ج + م + ي + ل" },
    { id: "w44", word: "جَدِيد", latin: "jadid", meanings: { es: "nuevo", de: "neu", pl: "nowy", pt: "novo", uk: "новий", la: "nuevo" }, breakdown: "ج + د + ي + د" },
    { id: "w45", word: "قَدِيم", latin: "qadim", meanings: { es: "viejo / antiguo", de: "alt", pl: "stary", pt: "velho", uk: "старий", la: "viejo / antiguo" }, breakdown: "ق + د + ي + م" },
    { id: "w46", word: "كَبِير", latin: "kabir", meanings: { es: "grande", de: "groß", pl: "duży", pt: "grande", uk: "великий", la: "grande" }, breakdown: "ك + ب + ي + ر" },
    { id: "w47", word: "صَغِير", latin: "saghir", meanings: { es: "pequeño", de: "klein", pl: "mały", pt: "pequeno", uk: "маленький", la: "pequeño" }, breakdown: "ص + غ + ي + ر" },
    { id: "w48", word: "الْيَوْم", latin: "al-yawm", meanings: { es: "hoy", de: "heute", pl: "dzisiaj", pt: "hoje", uk: "сьогодні", la: "hoy" }, breakdown: "ا + ل + ي + و + م" },
    { id: "w49", word: "غَدًا", latin: "ghadan", meanings: { es: "mañana", de: "morgen", pl: "jutro", pt: "amanhã", uk: "завтра", la: "mañana" }, breakdown: "غ + د + ا" },
    { id: "w50", word: "كَيْفَ حَالُكَ", latin: "kayfa haluk", meanings: { es: "¿cómo estás?", de: "wie geht es dir? (m)", pl: "jak się masz? (m)", pt: "como estás? (m)", uk: "як справи? (м)", la: "cómo estás? (a hombre)" }, breakdown: "ك + ي + ف +   + ح + ا + ل + ك" }
];
